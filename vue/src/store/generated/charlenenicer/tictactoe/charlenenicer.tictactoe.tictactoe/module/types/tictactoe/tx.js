...
const baseMsgCreateGame = { creator: "" };
...
const baseMsgCreateGameResponse = { id: 0 };
...
export class MsgClientImpl {
    ...
    CreateGame(request) {
        ...
        const promise = this.rpc.request("charlenenicer.tictactoe.tictactoe.Msg", "CreateGame", data);
